# Development Policy Category pages
...
These pages are [updated nightly](https://github.com/digital-land/development-policy-category/actions) by the [GitHub Action](.github/workflows/run.yml).
